...
/**
 * Clase HiloEurovision que extiende la clase Thread Se encarga de recibir el
 * objeto con la informacion de cada cliente pais para hacer el insert en la
 * tabla de la Fase Nacional. Ejecuta el insert.
 * 
...
public class HiloEurovision extends Thread {
	...
	public void run() {
		...
		try {
			...
			/*
			 * System.out.println("Informacion recibida por el servidor: " +
			 * resultadosRecibidos.getPais() + " " +
			 * resultadosRecibidos.getCantantePrimero() + " " +
			 * resultadosRecibidos.getCantanteSegundo() + " " +
			 * resultadosRecibidos.getCantanteTercero());
			 */
			
			// Realizar operaciones con resultadosRecibidos segun sea necesario
